      ...
      {tab === "scan" ? (
        <View style={styles.scanContainer}>
          {!permission?.granted ? (
            ...
            <View style={styles.cameraWrapper}>
              ...
              <Text style={styles.scanHint}>Point your camera at a KobKlein payment QR</Text>
            </View>
          )}
        </View>
      ) : (
        <View style={styles.qrContainer}>
          <Card variant="gold" style={styles.qrCard}>
            ...
            {user?.handle && <Text style={styles.qrHandle}>@{user.handle}</Text>}
          </Card>
...
const styles = StyleSheet.create({
  ...
  qrName: { fontFamily: fonts.sansSemiBold, fontSize: 18, color: colors.textHeading },
  qrKid: { fontFamily: fonts.sans, fontSize: 14, color: colors.textMuted, marginTop: 4 },
  qrHandle: { fontFamily: fonts.sansMedium, fontSize: 14, color: colors.gold, marginTop: 2 },
  qrHint: {
    fontFamily: fonts.sans,
    fontSize: 13,
    color: colors.textMuted,
